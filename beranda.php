...
if(isset ($_SESSION['username'])){
  ...
  $sql_jml_adm = $mysqli->query($query_jml_adm);
  ...
  $sql_jml_wtr = $mysqli->query($query_jml_wtr);
  ...
  $sql_jml_ksr = $mysqli->query($query_jml_ksr);
  ...
  $sql_jml_own = $mysqli->query($query_jml_own);
  ...
  $sql_jml_plg = $mysqli->query($query_jml_plg);
            ...
            <div class="span9">
              ...
              <div class="widget-box">
                <?php
                  ...
                  $sql_data_wtr = $mysqli->query($query_data_wtr);
                  $no = 1;
                ?>
              ...
              <div class="widget-box">
                <?php
                  ...
                  $sql_data_ksr = $mysqli->query($query_data_ksr);
                  $no_ksr = 1;
                ?>
              ...
              <div class="widget-box">
                <?php
                  ...
                  $sql_data_own = $mysqli->query($query_data_own);
                  $no_own = 1;
                ?>
              ...
              <div class="widget-box">
                <?php
                  ...
                  $sql_data_plg = $mysqli->query($query_data_plg);
                  $no_plg = 1;
                ?>
                ...
                <?php
                  if(isset($_POST['hapus_user'])){
                    ...
                    $sql_hapus_user = $mysqli->query($query_hapus_user);
                    if($sql_hapus_user){
                  ...
                  if(isset($_POST['validasi'])){
                    ...
                    $sql_validasi = $mysqli->query($query_validasi);
                    if($sql_validasi){
                      header('location: beranda.php');
                      //$_SESSION['daftar'] = 'sukses';
                    }
                  ...
                  if(isset($_POST['unvalidasi'])){
                    ...
                    $sql_unvalidasi = $mysqli->query($query_unvalidasi);
                    if($sql_unvalidasi){
                      header('location: beranda.php');
                      //$_SESSION['daftar'] = 'sukses';
                    }
