  ...
  <div class="container-fluid">
    ...
    ?>
      ...
      <?php
        ...
        $sql_lihat_order = $mysqli->query($query_lihat_order);
            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  ...
                  $sql_order_fiks = $mysqli->query($query_order_fiks);
                ...
                <?php
                  ...
                  $sql_harga = $mysqli->query($query_harga);
    ...
    <div class="row-fluid">
              ...
              <div class="btn-icon-pg">
                <ul>
                  ...
                  <?php
                    ...
                    $sql_lihat_pesan = $mysqli->query($query_lihat_pesan);
                    ...
                    $sql_data_makanan = $mysqli->query($query_data_makanan);
                    $no_makanan = 1;
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $sql_tambah_pesan= $mysqli->query($query_tambah_pesan);

                        $query_lihat_pesannya = "select * from tb_pesan order by id_pesan desc limit 1";
                        $sql_lihat_pesannya = $mysqli->query($query_lihat_pesannya);
                        ...
                        $sql_olah_stok= $mysqli->query($query_olah_stok);
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <?php
                ...
                $sql_draft_pesan = $mysqli->query($query_draft_pesan);
      ...
      <?php
          ...
          if(isset($_POST['hapus_pesan'])){
            ...
            $sql_hapus_pesan = $mysqli->query($query_hapus_pesan);
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $sql_simpan_order = $mysqli->query($query_simpan_order);

            $query_tampil_order = "select * from tb_order where id_pengunjung = $id order by id_order desc limit 1";
            $sql_tampil_order = $mysqli->query($query_tampil_order);
            ...
            $sql_ubah_jumlah = $mysqli->query($query_ubah_jumlah);
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              $sql_stok = $mysqli->query($query_stok);
              ...
              $sql_kelola_stok = $mysqli->query($query_kelola_stok);
              $sql_kurangi_stok = $mysqli->query($query_kurangi_stok);
              $sql_proses_ubah = $mysqli->query($query_proses_ubah);
            }
