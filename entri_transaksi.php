            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  ...
                  $sql_order = $mysqli->query($query_order);
                ...
                <?php
                  ...
                  if(isset($_REQUEST['hapus_order'])){
                    ...
                    $sql_hapus_order = $mysqli->query($query_hapus_order);
                    $sql_hapus_pesan_order = $mysqli->query($query_hapus_pesan_order);
                    if($sql_hapus_order){
            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  ...
                  $sql_sudah_order = $mysqli->query($query_sudah_order);
                ...
                <?php
                  ...
                  if(isset($_REQUEST['hapus_transaksi'])){
                    ...
                    $sql_hapus_transaksi = $mysqli->query($query_hapus_transaksi);
