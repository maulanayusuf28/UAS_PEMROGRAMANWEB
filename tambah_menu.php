...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu'])){
    ...
    $sql_data_edit = $mysqli->query($query_data_edit);
        ...
        <div class="widget-content" >
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              $sql_tambah_masakan= $mysqli->query($query_tambah_masakan);
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $sql_ubah_masakan = $mysqli->query($query_ubah_masakan);
              ...
              if($gbr != "" || $gbr != null){
                ...
                $sql_ubah_gambar = $mysqli->query($query_ubah_gambar);
              }
